...
function install_get_default_options(): array
{
    ...
    if (empty($options)) {
        $options = [
            ...
            'title' => 'Typecho Simple Mibiao',
            'description' => 'Your description here.',
            'keywords' => 'typecho,simple,mibiao,TSM',
            'rewrite' => 0,
            'frontPage' => 'recent',
            'frontArchive' => 0,
        ...
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            ...
            <div id="typecho-welcome">
                ...
                <ul>
                    ...
                    <li><a id="site-url" href=""><?php _e('点击这里查看您的米表'); ?></a></li>
                </ul>
                <p><?php _e('希望您能尽情享用 Typecho Simple Mibiao 简单米表带来的乐趣!'); ?></p>
            </div>
        </div>
    </div>
    <script>
...
function install_step_1()
{
    ...
    <div class="row typecho-page-main">
        <div class="col-mb-12 col-tb-8 col-tb-offset-2">
            <div class="typecho-page-title">
                <h2><?php _e('欢迎使用 Typecho 简单米表'); ?></h2>
            </div>
            <div id="typecho-welcome">
                <form autocomplete="off" method="post" action="install.php">
                    ...
                    <h3><?php _e('许可及协议'); ?></h3>
                    <ul>
                        <li><?php _e('简单米表基于 Typecho 开发，英文名：Typecho Simple Mibiao，可简称为：TSM'); ?></li>
            ...
            <form autocomplete="off" action="install.php" method="post">
                <ul class="typecho-option">
                    <li>
                        ...
                        <p class="description"><?php _e('请根据您的数据库类型选择合适的适配器，推荐使用 MySQL'); ?></p>
